...
ofp = open(os.path.join(os.getcwd(), "output", "client.out"), "w")
efp = open(os.path.join(os.getcwd(), "output", "client.err"), "w")
lfn = os.path.join(os.getcwd(), "logs", "client.log")
...
from client.clientmain import ClientMain


client = ClientMain(settings)
client.forever()